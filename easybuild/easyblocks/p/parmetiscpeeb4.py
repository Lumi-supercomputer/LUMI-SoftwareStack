...
class EB_ParMETIScpeEB4(EasyBlock):
    """Support for building and installing ParMETIS."""

    def __init__(self, *args, **kwargs):
        """Easyblock constructor."""

        super(EB_ParMETIScpeEB4, self).__init__(*args, **kwargs)
    ...
    def sanity_check_step(self):
        ...
        super(EB_ParMETIScpeEB4, self).sanity_check_step(custom_paths=custom_paths)
