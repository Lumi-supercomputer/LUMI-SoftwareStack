...
class EB_EasyBuildMetaLUMI(PythonPackage):
    """Support for install EasyBuild."""

    def __init__(self, *args, **kwargs):
        """Initialize custom class variables."""
        super(EB_EasyBuildMetaLUMI, self).__init__(*args, **kwargs)
    ...
    def check_readiness_step(self):
        ...
        super(EB_EasyBuildMetaLUMI, self).check_readiness_step()
        ...
        try:
            ...
            for pkg in self.easybuild_pkgs:
                ...
                if len(seldirs) != 1:
                    ...
                    super(EB_EasyBuildMetaLUMI, self).install_step()
...
#                                         pkg_regex.pattern, easy_install_pth, easy_install_pth_txt)
        ...
        super(EB_EasyBuildMetaLUMI, self).sanity_check_step(custom_paths=custom_paths, custom_commands=custom_commands)
    ...
    def make_module_extra(self):
        ...
        """
        txt = super(EB_EasyBuildMetaLUMI, self).make_module_extra()
    ...
    def make_module_step(self, fake=False):
        ...
        modpath = super(EB_EasyBuildMetaLUMI, self).make_module_step(fake=fake)
