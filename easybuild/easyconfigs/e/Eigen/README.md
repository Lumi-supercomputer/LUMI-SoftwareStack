...
### 3.4.0 for 21.12/23.03/24.11/25.03/25.03

-   Looks like the Eigen people returned to a normal version numberings, so adapted the
    EasyConfig.


### 5.0.1 for 26.03

-   Trivial version update of the EasyConfig for 3.4.0. Version 4 was skipped by Eigen.
