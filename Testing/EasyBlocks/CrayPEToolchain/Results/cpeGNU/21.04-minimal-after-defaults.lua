...
local root = "/run/user/27155/EBtesting/software/cpeGNU/21.04-minimal-after-defaults"
...
setenv("EBDEVELCPEGNU", pathJoin(root, "easybuild/cpeGNU-21.04-minimal-after-defaults-easybuild-devel"))
