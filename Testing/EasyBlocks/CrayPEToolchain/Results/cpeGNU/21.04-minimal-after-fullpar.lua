...
local root = "/run/user/27155/EBtesting/software/cpeGNU/21.04-minimal-after-fullpar"
...
setenv("EBDEVELCPEGNU", pathJoin(root, "easybuild/cpeGNU-21.04-minimal-after-fullpar-easybuild-devel"))
