if os.getenv( '_LUMI_LMOD_DEBUG' ) ~= nil then
  LmodMessage( 'DEBUG: In ' .. myModuleFullName () .. ' (generated from stack_partition/LUMI-partition.EB.tmpl.lua), the LMOD mode is ' .. mode() )
end
...
prepend_path( 'MODULEPATH', pathJoin( root, 'stack', stack, partition, 'manual/modules' ) )
-- prepend_path( 'MODULEPATH', pathJoin( root, 'stack', stack, partition, 'spack' ) )
prepend_path( 'MODULEPATH', pathJoin( root, 'stack', stack, partition, 'easybuild/modules' ) )
