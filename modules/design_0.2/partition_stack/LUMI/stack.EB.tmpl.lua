...
whatis( 'Enables the LUMI/LUMI_STACK_VERSION software stack for the LUMI_PARTITION partition.' )

help( [[
This module enables the LUMI-VERSION software stack for the LUMI_PARTITION partition.
