...
#
create_link "../../../../$repo/modules/CrayOverwrite/core/cpe/restore-defaults.lua" \
...
#
create_link "../../$repo/modules/CrayEnv.lua"  "$installroot/modules/SoftwareStack/CrayEnv.lua"
...
do
    create_link "../../$repo/modules/LocalStack/$dir"  "$installroot/modules/SoftwareStack/$dir"
done
...
#then
#    create_link "../../spack/etc/modules/spack"  "$installroot/modules/SoftwareStack/spack"
#fi
...
#
create_link "../../$repo/modules/init-lumi" "$installroot/modules/init-$repo/init-lumi"
...
#
create_link "../$repo/modules/StyleModifiers" "$installroot/modules/StyleModifiers"
