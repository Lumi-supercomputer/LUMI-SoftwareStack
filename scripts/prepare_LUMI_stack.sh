...
make_dir $installroot/modules/Infrastructure/LUMI/$stack_version/partition/CrayEnv
make_dir $installroot/modules/Infrastructure/LUMI/$stack_version/partition/system
