#! /bin/bash
#
# This is a script to enable the LUMI software stack using as much as possible
# data from the system HPE Cray PE configuration file
# /etc/cray-pe.de/cray-pe-configuration.sh. Hence it will only work well
# on nodes with the upgraded file, adapted for LMOD.
#
