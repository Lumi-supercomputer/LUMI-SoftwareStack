...
#
# Script to initialize a new CPE in CrayEnv. It should only be used if the
# CPE version is not immediately also offered in a LUMI stack as the
# prepare_LUMI_stack.sh script does what this script does and more.
#
...
cat <<EOF
  ...
  * Initialising the CPE $CPEversion in CrayEnv
