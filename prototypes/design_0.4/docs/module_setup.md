...
### Features of the module system on LUMI
  ...
  * When it matters, the module system will automatically select the software for
    ...
    NOTE:
      ...
      * LMOD 8.3.x, the default on Cray with the 21.04 software release: ``module update``
...
See [ files_used.md, section "LMOD subdirectory"](files_used.md#_lmod_subdirectory).
