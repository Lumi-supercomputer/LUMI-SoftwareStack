...
#
# On Eiger:
# - Lua:  5.3.4 -> Simply start lua to find out
# - TCL:  8.6.7 -> puts [info patchlevel]
# - Lmod: 8.3.1 -> module --version
#
lua_version=5.3.4
...
#
cd $HOME/work
# https://prdownloads.sourceforge.net/tcl/tcl8.6.7-src.tar.gz
